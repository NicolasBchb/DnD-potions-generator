...
TABLES = {
    ...
    "effets_secondaires": [
        "Narcolepsie. Endort l'utilisateur pendant 1d4 heures.",
        "Loup-garou intérieur. Pousse rapide de poils sur tout le corps pendant 1d6 heures.",
        "Larmes de sang. Saignement des yeux pendant 1d4 rounds.",
        "Cauchemar éveillé. Hallucinations vives pendant 1d10 minutes.",
        "Prémonition macabre. Flashbacks de votre propre mort éventuelle.",
        "Épiderme fracturé. La peau se fissure et apparaît déformée pendant 1d4 heures.",
        "Taches du destin. Des taches apparaissent sur la peau pendant 1d6 jours.",
        "Tempête intestinale. Diarrhée pendant 1d4 heures.",
        "Vague nauséabonde. Vomissements pendant 1d4 rounds.",
        "Brouillard oculaire. Vision floue pendant 1d6 rounds.",
        "Voile des ténèbres. Cécité pendant 1d4 rounds.",
        "Silence absolu. Surdité pendant 1d4 rounds.",
        "Langue scellée. Mutisme pendant 1d6 rounds.",
        "Hémorragie fatale. Perte de santé due à un saignement rapide (1d6 dégâts par round pendant 1d4 rounds).",
        "Accent maudit. Un accent horrible soudain pendant 1d6 heures.",
        "Danse compulsive. Une envie irrésistible de danser pendant 1d4 rounds.",
        "Chuchotements infernaux. Entendre des démons pendant 1d6 rounds.",
        "Vertige persistant. Perte d'équilibre pendant 1d4 rounds.",
        "Goût de terre. Tout a un goût de terre pendant 1d6 heures.",
        "Fontaine buccale. Salivation excessive pendant 1d4 rounds.",
        "Esprit embrumé. Perte d'intelligence (-1d4 à l'INT) pendant 1d6 heures.",
        "Faiblesse musculaire. Perte de force (-1d4 à la FOR) pendant 1d6 heures.",
        "Lenteur maladive. Perte de vitesse (-1d4 à la DEX) pendant 1d6 heures.",
        "Charme brisé. Perte de charisme (-1d4 au CHA) pendant 1d6 heures.",
        "Euphorie soudaine. Bonheur authentique pendant 1d6 heures.",
        "Faim vorace. Faim extrême.",
        "Soif ardente. Soif extrême.",
        "Souffle coupé. Difficultés à respirer pendant 1d4 rounds.",
        "Moustache magique. Moustache soudaine pendant 1d6 heures.",
        "Venin insidieux. Empoisonnement (1d6 dégâts de poison par round pendant 1d4 rounds).",
        "Statue vivante. Pétrification pendant 1d4 rounds.",
        "Tournis persistant. Étourdissement pendant 1d4 rounds.",
        "Enracinement. Immobilisation pendant 1d4 rounds.",
        "Passion dévorante. Libido augmentée pendant 1d6 heures.",
        "Nervosité extrême. Agitation nerveuse pendant 1d4 rounds.",
        "Démangeaisons infernales. Démangeaisons pendant 1d6 heures.",
        "Peau marquée. Éruptions cutanées pendant 1d6 jours.",
        "Appel des ours. Attire les ours pendant 1d6 heures.",
        "Boue éternelle. Recouvert de boue magiquement pendant 1d4 heures.",
        "Pestilence nauséabonde. Odeur horrible pendant 1d6 heures.",
        "Crâne dégarni. Calvitie soudaine.",
        "Ballonnement magique. Gonflement du corps pendant 1d4 heures.",
        "Objet perdu. Perte d'un objet aléatoire.",
        "Malédiction imprévue. Malédiction aléatoire pendant 1d6 jours.",
        "Choc douloureux. Dégâts (1d6 dégâts immédiats).",
        "Vulnérabilité magique. Faiblesse à un type de dégâts magiques pendant 1d6 heures.",
        "Fragilité physique. Faiblesse aux dégâts physiques pendant 1d6 heures.",
        "Culpabilité écrasante. Sentiments de culpabilité pendant 1d6 heures.",
        "Angoisse persistante. Sentiments d'anxiété pendant 1d6 heures.",
        "Honte profonde. Sentiments de honte pendant 1d6 heures.",
        "Éternuements magiques. Éternuements incontrôlables pendant 1d4 rounds.",
        "Larmes amères. Pleurs incontrôlables pendant 1d4 rounds.",
        "Chant héroïque. Besoin de chanter de la musique héroïque pendant 1d6 rounds.",
        "Câlins forcés. Envie de faire des câlins pendant 1d6 rounds.",
        "Doigts agiles. Kleptomanie pendant 1d6 heures.",
        "Rots tonitruants. Rots incontrôlables pendant 1d4 rounds.",
        "Nez bouché. Perte d'odorat pendant 1d6 heures.",
        "Nuits blanches. Insomnie pendant 1d6 heures.",
        "Ombre de la paranoïa. Paranoïa pendant 1d6 heures.",
        "Étoile filante inversée. Malchance (-1d4 aux jets de dés) pendant 1d6 heures.",
        "Imps maléfiques. Invocation d'imps qui veulent vous tuer (1d4 imps).",
        "Essaim furieux. Invocation d'abeilles en colère (1d6 abeilles).",
        "Peur irrationnelle. Peur de quelque chose pendant 1d6 heures.",
        "Folie passagère. Folie temporaire pendant 1d6 rounds.",
        "Sérénité totale. Relaxation totale pendant 1d6 heures.",
        "Sens exacerbés. Appréciation accrue des couleurs et des sons pendant 1d6 heures.",
        "Voyage psychédélique. Trip intense pendant 1d6 rounds.",
        "Désir brûlant. Désir douloureux pendant 1d6 rounds.",
        "Confiance excessive. Confiance en soi augmentée pendant 1d6 heures.",
        "Témérité. Imprudence pendant 1d6 heures.",
        "Colère noire. Rage incontrôlable pendant 1d6 rounds.",
        "Mélancolie profonde. Tristesse intense pendant 1d6 heures.",
        "Tourbillon mental. Vertiges pendant 1d4 rounds.",
        "Douleur fulgurante. Douleur intense (1d6 dégâts).",
        "Esprit hanté. Possession légère pendant 1d6 rounds.",
        "Allergie cruelle. Réaction allergique à votre nourriture préférée pendant 1d6 heures.",
        "Identité volée. Croyance forte que vous êtes quelqu'un d'autre pendant 1d6 heures.",
        "Dette imprévue. Dette soudaine (perte de 1d6 x 10 pièces d'or).",
        "Humeur de grognon. Grincheux pendant 1d6 heures.",
        "Spasmes incontrôlables. Spasmes musculaires pendant 1d4 rounds.",
        "Ballonnement magique. Sensation de ballonnement pendant 1d6 heures.",
        "Rhume magique. Rhume pendant 1d6 heures.",
        "Fièvre ardente. Fièvre pendant 1d6 heures.",
        "Légèreté étrange. Devenir étrangement léger (réduction de poids de 50%) pendant 1d6 heures.",
        "Affaiblissement général. Faiblesse générale (-1d4 à toutes les caractéristiques) pendant 1d6 heures.",
        "Rage de combat. Envie de combattre pendant 1d6 rounds.",
        "Amitié compulsive. Besoin de se faire des amis pendant 1d6 heures.",
        "Nausées persistantes. Nausées pendant 1d4 rounds.",
        "Montagnes russes émotionnelles. Sautes d'humeur pendant 1d6 heures.",
        "Dépendance. Addiction à la potion pendant 1d6 jours.",
        "Soif de boisson. Besoin impérieux de boire de l'alcool pendant 1d6 heures.",
        "Spiritueux. Ivresse pendant 1d6 heures.",
        "Toux incontrôlable. Toux incontrôlable pendant 1d4 rounds.",
        "Verbiage incessant. Bavardage incontrôlable pendant 1d6 rounds.",
        "Douleurs sourdes. Douleurs légères (1d4 dégâts).",
        "Arrière-goût maudit. Mauvais goût dans la bouche pendant 1d6 heures.",
        "Vertiges persistants. Vertiges pendant 1d4 rounds.",
        "Fou rire. Rires incontrôlables pendant 1d6 rounds."
    ],
    "intensite": [
